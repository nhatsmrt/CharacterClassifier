...
class ThirdModel:
    def __init__(self, inp_w, inp_h, inp_d, n_classes = 47, keep_prob = 0.8, use_gpu = False):
    ...
    def create_network(self, inp_w, inp_h, inp_d):
        ...
        self._fc1 = self.feed_forward(self._flat, name = "fc1", inp_channel = 1152, op_channel = 200)
        self._fc2 = self.feed_forward(self._fc1, inp_channel = 200, op_channel = self._n_classes, name = "fc2", op_layer = True)
